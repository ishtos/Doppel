...
- [x] Phase M: レッスンコンテンツ拡充 (5レッスン追加、全カテゴリ×全難易度カバー)
...
- **全6カテゴリ × 3難易度 = 18スロットをカバー** (一部カテゴリは同難易度で複数レッスンあり)

## 8. 本日完了したタスク (2026-04-23)
- レッスンコンテンツ拡充 (Phase M)
  - `seed_data.dart`: 5つの新レッスンを追加 (lesson-017〜021)
    - lesson-017: "Office Small Talk" (ビジネス/初級, 286語)
    - lesson-018: "Apartment Hunting" (日常会話/中級, 288語)
    - lesson-019: "Dinner Party Conversations" (日常会話/上級, 279語)
    - lesson-020: "TED: The Joy of Reading" (TEDスタイル/初級, 289語)
    - lesson-021: "TED: The Science of Sleep" (TEDスタイル/中級, 306語)
  - 全カテゴリで初級・中級・上級の3難易度が揃った

## 9. Handover Note for Next Run
Phase A-M まで全て完了。レッスンコンテンツを16→21に拡充し、全6カテゴリで初級・中級・上級が揃った。
次は **リリース準備** として以下から着手:
