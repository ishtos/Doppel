...
- [x] Phase M: レッスンコンテンツ拡充 (8本追加 → 全24レッスン、全カテゴリ4本均等化)
...
## 7. Lesson Content
- **24レッスン** (各約250-320語) ← 16→24に拡充
- **カテゴリ (各4本):** ニュース、ビジネス、日常会話、TEDスタイル、スポーツ、時事ネタ
- **難易度別 WPM:** 初級 100 / 中級 130 / 上級 150
- **追加レッスン (Phase M):**
  - Global Health Update (ニュース/中級)
  - Your First Day at Work (ビジネス/初級)
  - At the Doctor's Office (日常会話/中級)
  - Apartment Hunting (日常会話/上級)
  - TED: The Science of Sleep (TEDスタイル/初級)
  - TED: Learning from Failure (TEDスタイル/中級)
  - Marathon Training Guide (スポーツ/中級)
  - Social Media and Society (時事ネタ/初級)

## 8. 本日完了したタスク (2026-04-26)
- レッスンコンテンツ拡充 (Phase M)
  - `seed_data.dart`: 8本の新レッスンを追加 (lesson-017 〜 lesson-024)
  - 全6カテゴリを各4レッスンに均等化 (合計16→24レッスン)
  - 不足していた難易度レベルを補完:
    - 日常会話: 中級・上級を追加
    - TEDスタイル: 初級・中級を追加
    - ビジネス: 初級を追加
...
Phase A-M まで全て完了。レッスンコンテンツを24本に拡充し、全カテゴリ4本・難易度バランスを改善済み。
...
- Widget tests の補強 (Feedback / Lesson 画面)
