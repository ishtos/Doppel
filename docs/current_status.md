...
- [x] Phase M: レッスンコンテンツ拡充 (16→24レッスン、全カテゴリ×全難易度カバー)
...
- **全カテゴリで初級・中級・上級が少なくとも1つ以上存在**

## 8. 本日完了したタスク (2026-04-29)
- レッスンコンテンツ拡充 (Phase M)
  - `seed_data.dart`: 8つの新規レッスン追加 (16→24レッスン)
  - lesson-017: First Day at the Office (ビジネス/初級) - オフィス初日の案内
  - lesson-018: At the Doctor's Office (日常会話/中級) - 医師との診察会話
  - lesson-019: Apartment Hunting (日常会話/上級) - 賃貸物件の問い合わせ
  - lesson-020: TED: The Joy of Reading (TEDスタイル/初級) - 読書の効能
  - lesson-021: TED: The Science of Sleep (TEDスタイル/中級) - 睡眠科学
  - lesson-022: Local Community News (ニュース/初級) - 地域コミュニティニュース
  - lesson-023: City Marathon Race Day (スポーツ/初級) - マラソン実況
  - lesson-024: Digital Privacy Debate (時事ネタ/中級) - デジタルプライバシー

## 9. Handover Note for Next Run
Phase A-M まで全て完了。レッスンコンテンツを16から24に拡充し、全6カテゴリ×3難易度レベルをカバー済み。
次は **リリース準備** として以下から着手:
